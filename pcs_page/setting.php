					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
								...
								<input type="hidden" id="registlinenameplan"
									name="registlinenameplan" value="">
							...
							<div class="col-md-6">
								<div style="text-align: right;">
									<button type="button" style="width: 100%;"
										class="btn btn-danger btn-target d-none"
										id="ongoingBtn">ONGOING PROCESS
										<b>[BACK]</b></button>
								</div>
								<div style="text-align: right;">
									<button type="submit" style="width: 100%;"
										class="btn btn-success btn-target d-none"
										id="setplanBtn">SET PLAN
										<b>[PLAY]</b></button>
								</div>
							</div>
							<div class="col-md-6">
								<button href="index.php" class="btn btn-secondary"
									style="width: 100%;" id="menuBtn">MAIN MENU
									<b>[BACK]</b></button>
							</div>
						</div>
					</div>
