                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                                <div class="col-4">
                                                        ...
                                                        <table>
                                                                <tr>
                                                                        <th colspan="2" class="col-md-6 text-center"
                                                        ...
                                                        <table>
                                                                <tr>
                                                                        <th colspan="2" class="text-center"
                                                                                style="height: 47px">OVERALL INSPECTION
                                                                        </th>
                                                                </tr>
                                                                <tr>
                                                                        <th class="col-md-6 text-center"
                                                                                style="height: 60px">GOOD</th>
                                                                        <th class="col-md-6 text-center">NG</th>
                                                                </tr>
                                                                <tr>
                                                                        <td class="col-md-6 text-center"
                                                                                style="height: 85px;">25</td>
                                                ...
                                                <div class="col-4">
                                                        <table>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td class="numeric-cell col-md-2 text-center"
                                        ...
                                        <div class="row">
                                                <div class="col-4">
                                                        ...
                                                        <table>
                                                                <tr>
                                                                        <th class="th-normal col-md-8"
                                                                                style="height:46px">Starting Balance
                                                                                Delay:</th>
                                                                        <td class="col-md-4">0</td>
                                                                </tr>
                                                                <tr>
                                                                        <th class="th-normal col-md-8"
                                                                                style="height:45px">Conveyor Speed:
                                                                        </th>
                                                                        <td class="col-md-4">00:00:00</td>
                                                                </tr>
                                                                <tr>
                                                                        <th class="th-normal col-md-8"
                                                                                style="height:45px">Takt Time:</th>
                                                                        <td class="col-md-4">00:00:00</td>
                                                                </tr>
                                                                <tr>
                                                                        <th class="th-normal col-md-8"
                                                                                style="height:45px">Working Time
                                                                                Plan:</th>
                                                                        <td class="col-md-4">0</td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <div class="col-8">
                                                        ...
                                                        <div class="card" style="border: 2px solid #4E4E4E">
                                                                ...
                                                                <a target="_blank"
                                                                        ...
                                                                        class="card-link"
                                                                        style="padding: 7px; text-align: left">Andon
                                                                        Details</a>
                                                        </div>
