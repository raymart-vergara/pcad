                        ...
                        <div class="col-sm-12">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <button type="button" class="btn bg-secondary btn-block" onclick="export_hourly_output()"><i class="fas fa-download"></i> Hourly Output</button>
                                    </div>
                                    <div class="col-sm-3">
                                    <button type="button" class="btn bg-primary btn-block" onclick="get_hourly_output()"><i class="fas fa-search"></i> Search</button>
                                    </div>
                                </div>
                                <div id="accordion_hourly_output_legend">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <a class="d-block w-100 text-dark" data-toggle="collapse" href="#collapseOneHourlyOutputLegend">
                                            Hourly Output Legend
                                        </a>
                                        </h4>
                                    </div>
                                    <div id="collapseOneHourlyOutputLegend" class="collapse" data-parent="#accordion_hourly_output_legend">
                                        <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-4 col-lg-4 p-1 bg-success"><center>Target Met</center></div>
                                            <div class="col-sm-4 col-lg-4 p-1 bg-warning"><center>Target Partially Met</center></div>
                                            <div class="col-sm-4 col-lg-4 p-1 bg-danger"><center>Target Not Met</center></div>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
