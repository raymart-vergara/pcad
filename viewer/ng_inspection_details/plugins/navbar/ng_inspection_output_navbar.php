                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            ...
                            <li><a href="../good_inspection_details/inspection_details.php" class="dropdown-item">Inspection Output - GOOD</a></li>
                            <li><a href="../ng_inspection_details/inspection_details_ng.php" class="dropdown-item active" style="background: #4361EE;">Inspection Output - NG</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
