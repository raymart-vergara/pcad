...
<div class="content-wrapper" style="background: #FFF;">
        ...
        <section class="content">
                <div class="col-md-12 m-0 p-0">
                        <div class="card" style="border-top: 5px solid #ca3f3f;" id="proceed_to_no_good_table">
                                                ...
                                                <div class="card card-light" style="background: #fcfcfc;">
                                                        <div class="m-4">
                                                                ...
                                                                <div class="row mt-2 mb-4">
                                                                        <div class="col-sm-2">
                                                                                <!-- export button -->
                                                                                <button class="btn btn-block d-flex justify-content-left" id="export_no_good_record_viewer" onclick="export_no_good_record_viewer()"
