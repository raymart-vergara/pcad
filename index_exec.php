            ...
            <tbody>
               <tr>
                  <td class="header-width col-3 col-md-3" style="border-right: 1px solid #E0E0E0;">
                     <div class="header-div">
                        <div class="header-div-2">
                           <img class="icon-h1" src="dist/img/car-dark.png" data-light-src="dist/img/car-light.png"
                              data-dark-src="dist/img/car-dark.png">
                        </div>
                     ...
                     <div class="header-div">
                        <div class="header-div-2">
                           <img class="icon-h2" src="dist/img/setting-dark.png"
                              data-light-src="dist/img/setting-light.png" data-dark-src="dist/img/setting-dark.png">
                        </div>
                        <div class="header-div-3">
                  ...
                  <td class="header-width col-3 col-md-3" style="border-right: 1px solid #E0E0E0;">
                     <div class="header-div">
                        <div class="header-div-2">
                           <img class="icon-h3" src="dist/img/clock-dark.png" data-light-src="dist/img/clock-light.png"
                     ...
                     <div class="header-div">
                        <div class="header-div-2">
                           <img class="icon-h4" src="dist/img/calendar-dark.png"
                              data-light-src="dist/img/calendar-light.png" data-dark-src="dist/img/calendar-dark.png">
                        </div>
                        <div class="header-div-3">
