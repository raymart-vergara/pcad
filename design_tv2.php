...
<body>
        ...
        <div class="container-fluid">
                ...
                <table class="table mt-5 mb-5" style="height: 80px;">
                        <tbody class="m-0 p-0">
                                <tr>
                                        <td scope="col" class="equal-width pl-2" id="carmodel_label"
                                                style="vertical-align: middle;">Car Maker/Model:
                                        </td>
                                                ...
                                                <thead>
                                                        <tr style="height: 90px;">
                                                                <td colspan="3" class="equal-py"
                                                                        style="vertical-align: middle;">YIELD</td>
                                                                <td colspan="3" class="equal-py"
                                                                        style="vertical-align: middle;">PPM</td>
                                                        </tr>
                                                </thead>
                                        </table>
                                        <table class="table text-center m-0 p-0" style="border-top: none;">
                                                <tbody style="height: 400px;">
                                                        <tr>
                                                                ...
                                                                <td scope="col"
                                                                        style="vertical-align: middle; font-size: 35px;">
                                                                        TARGET</td>
                                                                <td scope="col" class="value-size1">
                                        ...
                                        <table>
                                                <tbody class="text-center">
                                                        <tr style="height: 60px;">
                                                                ...
                                                                <td scope="col"
                                                                        class="equal-plan-acct-hr font-plan-sub">Target
                                                                </td>
                                                                <td scope="col"
                                                                        class="equal-plan-acct-hr font-plan-sub">Actual
                                                                </td>
                                                                <td scope="col"
                                                                        class="equal-plan-acct-hr font-plan-sub">Gap
                                                                </td>
                                                        </tr>
                                                </tbody>
                                                <tbody class="text-center">
                                                        <tr>
                                                                ...
                                                                <td scope="col" id="plan_gap"
                                                                        class="plan_gap_value value-size2 equal-plan-acct-hr">
                                                                </td>
                                                        </tr>
                                                        <tr>
                                                                <td scope="col" class="font-plan equal-plan-acct-hr">
                                ...
                                <div class="carousel-item" style="height: 640px;">
                                        <table class="text-center mb-3">
                                                ...
                                                <tbody>
                                                        <tr>
                                                                <th scope="col"
                                                                        class="equal-insp font-plan-sub th-normal">GOOD
                                                                </th>
                                                                <td scope="col" id="insp_overall_g" class="value-size1">
                                                                </td>
                                                                <td scope="col" id="insp_overall_ng"
                                                                        class="value-size1">
                                                                </td>
                                                                <th scope="col"
                                                                        class="equal-insp font-plan-sub th-normal">NG
                                                                </th>
                                                        </tr>
                                                </tbody>
                                        </table>
                                ...
                                <div class="carousel-item" style="height: 640px;">
                                        <table>
                                                ...
                                                <tbody>
                                                        <tr>
                                                                <th
                                                                        class="th-normal equal-sub-details text-left font-others">
                                                                        Plan:
                                                                </th>
                                                                <td id="total_pd_mp"
                                                                        class="equal-sub-details text-left font-others-value">
                                                                </td>
                                                                <th
                                                                        class="th-normal equal-sub-details text-left font-others">
                                                                        Plan:
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td id="total_present_pd_mp"
                                                                        class="text-left font-others-value"></td>
                                                                <th class="th-normal text-left font-others">Actual:</th>
                                                                <td id="total_present_qa_mp"
                                                                        class="text-left font-others-value"></td>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td id="total_absent_pd_mp"
                                                                        class="text-left font-others-value"></td>
                                                                <th class="th-normal text-left font-others">Absent:</th>
                                                                <td id="total_absent_qa_mp"
                                                                        class="text-left font-others-value"></td>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td id="total_pd_mp_line_support_to"
                                                                        class="text-left font-others-value">
                                                                </td>
                                                                <th class="th-normal text-left font-others">Support:
                                                                </th>
                                                                <td id="total_qa_mp_line_support_to"
                                                                        class="text-left font-others-value">
                                                                </td>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td id="absent_ratio_pd_mp"
                                                                        class="text-left font-others-value"></td>
                                                                <th class="th-normal text-left font-others">Absent Rate:
                                                                </th>
                                                                <td id="absent_ratio_qa_mp"
                                                                        class="text-left font-others-value"></td>
                                                                <th class="th-normal text-left font-others">Working Time
                                                                        Actual:
                                                                </th>
                ...
                <div class="row">
                        <div class="col-4">
                                ...
                                <div>
                                        <button type="button"
                                                class="btn btn-info btn-block btn-resume d-none">RESUME<b>[ 3
                                                        ]</b></button>
                                </div>
                        </div>
                        <div class="col-4">
