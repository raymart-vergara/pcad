                ...
                <div class="card-body">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    if ($processing) {
                                        ...
                                        <div class="modal fade darkest-modal" id="plannotset" tabindex="-1"
                                            aria-labelledby="plannotsetLabel" aria-hidden="true" role="dialog"
                    ...
                    <div class="row mb-3">
                        <div class="col-4">
                                ...
                                <tr>
                                    <a target="_blank"
                                        ...
                                        <td id="insp_overall_g" class="col-md-4 text-center value-size"
                                            style="background: #95d5b2; cursor: pointer;">
                                        </td>
                                    </a>
                            ...
                            <br>
                            <div class="table-responsive m-0 p-0" style="max-height: 172px; overflow-y: auto;">
                            ...
                            <table>
                                <tr>
                                    <th style="cursor:pointer;"
                                        ...
                                        colspan="2" class="col-md-3 text-center">PD
                                        MANPOWER</th>
                                    <th style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        colspan="2" class="col-md-3 text-center">QA
                                        MANPOWER</th>
                                ...
                                <tr>
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="numeric-cell col-md-1 text-center" data-value="100" id="total_pd_mp">
                                    </td>
                                    <th style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="th-normal col-md-1">Plan:</th>
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="numeric-cell col-md-1 text-center" data-value="100" id="total_qa_mp">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="numeric-cell col-md-1 text-center" data-value="94"
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="numeric-cell col-md-1 text-center" data-value="97"
                                ...
                                <tr>
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="numeric-cell col-md-1 text-center" data-value="100"
                                ...
                                <tr>
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="numeric-cell col-md-1 text-center" data-value="6"
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="numeric-cell col-md-1 text-center" data-value="3"
                                ...
                                <tr>
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="col-md-2 text-center" style="background: #fae588"
                                    ...
                                    <td style="cursor:pointer;"
                                        onclick='window.open("http://172.25.116.188:3000/emp_mgt/viewer/dashboard.php","_blank")'
                                        class="col-md-2 text-center" style="background: #f38375;"
                    ...
                    <div class="row">
                        <div class="col-4 table-responsive">
                            <!-- mp based on process design -->
                            <div class="card">
                                <table>
                                    <tr style="height: 40px;">
                                        <th class="text-center" colspan="2">Process Design</th>
                                        <th class="text-center">Actual</th>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Sub Assy</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Bukumi</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Parts</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Layout</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Assy</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Shiage</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Dimension</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">ECT</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">ECT (Clamp)</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal"> Clamp Checking Option</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Appearance</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Assurance</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Jr Staff</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                    <tr>
                                        <th class="col-2 th-normal">Expert</th>
                                        <td class="col-2 text-center"></td>
                                        <td class="col-2 text-center"></td>
                                    </tr>
                                </table>
                        ...
                        <div class="col-8">
                            ...
                            <div class="card" style="border: 2px solid #4E4E4E">
                                <div id="chart-container1">
                                    <canvas id="andon_hourly_chart" height="54"></canvas>
                                </div>
                            </div>
                            ...
                            <div class="card" style="border: 2px solid #4E4E4E">
                                <div id="chart-container2">
                                    <canvas id="hourly_output_summary_chart" height="54"></canvas>
                                </div>
                            </div>
                            ...
                            <div class="card" style="border: 2px solid #4E4E4E">
                                <div id="chart-container3">
                                    <canvas id="ng_summary_chart" height="54"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
