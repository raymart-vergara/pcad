...
$plan_data_done_arr = get_plan_data($registlinename, $line_no, $day, $shift, $conn_pcad, 2);
...
$fields = array(
    $plan_data_done_arr['plan_target'],
    $plan_data_done_arr['plan_actual'],
    $plan_data_done_arr['plan_gap'],
    '',
    $plan_data_done_arr['acc_eff'],
    $plan_data_done_arr['acc_eff_actual'],
    $plan_data_done_arr['acc_eff_gap'],
    '',
    $target_hourly_output,
    $actual_hourly_output,
    $gap_hourly_output
);
fputcsv($f, $fields, $delimiter);
...
$fields = array(
    $plan_data_done_arr['yield_target'],
    $plan_data_done_arr['yield_actual'],
    '',
    $plan_data_done_arr['ppm_target'],
    $plan_data_done_arr['ppm_actual'],
    '',
    $insp_overall_g,
    $insp_overall_ng
);
