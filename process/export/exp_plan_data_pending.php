...
$fields = array(
    $plan_data_pending_arr['plan_target'],
    $plan_data_pending_arr['plan_actual'],
    $plan_data_pending_arr['plan_gap'],
    '',
    $plan_data_pending_arr['acc_eff'],
    $plan_data_pending_arr['acc_eff_actual'],
    $plan_data_pending_arr['acc_eff_gap'],
    '',
...
$fields = array(
    $plan_data_pending_arr['yield_target'],
    $plan_data_pending_arr['yield_actual'],
    '',
    $plan_data_pending_arr['ppm_target'],
    $plan_data_pending_arr['ppm_actual'],
    '',
    $insp_overall_g,
    $insp_overall_ng
);
